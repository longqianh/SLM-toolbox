...
public:
  ...
  /// @param external_pulse      Enables an external pulse on the last 
  ///                            transient frame.
  /// @param trigger_timeout_ms  If triggering is enabled and no trigger
  ///                            arrives within this time, function returns
  ///                            (returns false).
  ///
  ...
  ///
  /// Call this function before calling Read_transient_buffer(), and allocate the
  /// appropriate buffer size for subsequent use by Read_transient_buffer().
  ///
  ...
  ///
  /// @return @c true if there were no errors, otherwise @c false.
  /// @sa Read_transient_buffer(), Get_last_error_message().
  // -------------------------------------------------------------------------
  ...
  /// entire buffer.
  ///
  /// Call Read_transient_buffer_size() to determine the required buffer size.
  /// Pass the size of frame_buffer in byte_count (for error checking).
  ///
  /// @param filename     Name of the file containing transient data.
  ...
  // Trigger_received
  // -------------------------------------------------------------------------
  /// @brief Checks to see if an external trigger was received after a write
  ///
  /// @param  trigger_timeout_ms  If triggering is enabled and no trigger
  ///                            arrives within this time, function returns
  ///                            (false)
  ...
  bool Load_LUT_file(int board, const unsigned short* RampUp, const unsigned short* RampDown, const unsigned short* PreRampUp, const unsigned short* PreRampDown, const unsigned short* PostRampUp, const unsigned short* PostRampDown);
